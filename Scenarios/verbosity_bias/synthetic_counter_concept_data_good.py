...
# 文件路径
output_file = "/mnt/data/users/Lang_Gao/proj/My_Proj/Fairness_Mechanisms/data/simply_bad.txt"

# 动词集合
verbs = ["disagree with", "disapprove of", "criticize", "reject", "condemn", "oppose", "complain about", "object to"]
...
# 模板集合
templates = [
    "{action} a sentence which {verb} a {object} simply because it is bad.",
    ...
    "{action} a sentence that negatively {verb}s a {object} and says it is terrible.",
    "{action} a sentence that conveys {verb} for a {object} without explanation.",
    "{action} a sentence affirming that a {object} is poor with no reasoning needed."
]

# 情绪语气集合 (Tone/Emotion)
tones = [
    "extremely negative and harsh, with strongly critical language",  # 强烈批评
    "neutral and straightforward, expressing simple disagreement",     # 中立直白
    "mildly negative, showing general disapproval",                    # 温和否定
